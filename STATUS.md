...
|---|---|---|---|
| Product & architecture | [`SPEC.md`](./SPEC.md), [`ARCHITECTURE.md`](./ARCHITECTURE.md), [`ROADMAP.md`](./ROADMAP.md), [`DECISIONS.md`](./DECISIONS.md), [`EXTERNAL_SERVICES.md`](./EXTERNAL_SERVICES.md), [`QUESTIONS.md`](./QUESTIONS.md) | 7 | 11,445 words of strategy docs. 16 ADRs. 20 open questions. |
...
| Go backend | [`backend/`](./backend/) | 33 files + pdfsign package | Compiles, `go vet` clean, `go test -race ./...` green. Chi router, pgx, S3, Stripe, Twilio, SES, Mistral, Gemini. Real implementations, no TODO panics. |
...
- **22 Postgres tables**, **48+ indexes**.
- **60 tickets**, all priority P0 or P1 for MVP or first customer.
- **16 ADRs** locked into [`DECISIONS.md`](./DECISIONS.md).
...
4. **Provision infra:** DigitalOcean Droplet + managed Postgres, 5 S3 buckets (`ck-documents`, `ck-signed-pdfs`, `ck-audit-trail`, `ck-raw-uploads`, `ck-backups`). Scripts are in [`infra/scripts/`](./infra/scripts/); runbook in [`infra/README.md`](./infra/README.md). The `ck-audit-trail` bucket needs **Object Lock enabled at bucket create time** — see gotcha in `infra/README.md`.
